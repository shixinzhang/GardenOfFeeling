...
public class HttpResponseHandler {
    ...
    public void onSuccess(int statusCode, String content, LoadingPage loadingPage) {
    ...
    public void onFailure(Request request, IOException e) {
        ...
        if (loadingPage != null) {
            loadingPage.showPage(LoadingPage.LoadResult.ERROR);
        }
    }

    protected void setLoadingPage(LoadingPage loadingPage, View successedView) {
...
//                    loadingPage.removeAllViews();
                    loadingPage.showPage(LoadingPage.LoadResult.SUCCEED, successedView);
                    onSuccess(statusCode, content, loadingPage);
                } else {
                    onSuccess(statusCode, content);
                }
            } else {
